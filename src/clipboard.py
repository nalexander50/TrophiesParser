...
def build_invalid_metal_message(invalid_value: str, current_lines: list[str]) -> str:
...
def main():
    ...
    current_data: dict[TrophyMetadataCategory, str | TrophyMetal] = {}
    ...
    for line in input_lines:
        ...
        if category == TrophyMetadataCategory.METAL:
            metal = TrophyMetal.from_str(line.strip().replace(',', ''))
